...
<body id="page-top" class="fondo">
    ...
    <nav id="sidebar-wrapper">
        <ul class="sidebar-nav">
            ...
            <li class="sidebar-nav-item"><a href="#page-top">Reservas</a></li>
            <li class="sidebar-nav-item"><a class="dropdown-item text-dark" href="{{ route('logout') }}"
    ...
    <header class="masthead d-flex align-items-center">
        <div class="container px-4 px-lg-5 text-center">
            <h1 class="mb-1">La cabañita de Victoria</h1>
            <h3 class="mb-5"><em>Disfruta de nuestro estadia con el mejor servicio</em></h3>
            <a class="btn btn-primary btn-xl" href="{{ route('reservas.index') }}">Reserva Aqui</a>
        </div>
    </header>
    {{-- <!-- About-->
